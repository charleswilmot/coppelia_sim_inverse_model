...
def experiment(cfg):
    ...
    with Procedure(agent_conf, buffer_conf, simulation_conf, procedure_conf) as procedure:
        ...
        for episode_batch in range(n_episode_batch):
            ...
            print("batch {: 5d}\tevaluation:{}\tpolicy:{}\tcritic:{}\tsave:{}\trecord:{}\tdump buffers:{}".format(
                episode_batch + 1,
                evaluation,
                policy,
                critic,
            ...
            procedure.collect_train_and_log(policy=policy, critic=critic, evaluation=evaluation)
            if save:
                procedure.save()
            if record:
                procedure.replay(
