...
rsync -azPr --delete --exclude-from=<(ssh wilmot@fias.uni-frankfurt.de 'find ~/Documents/code/coppelia_sim_inverse_model/experiments/ -mtime +2 -mindepth 1 -maxdepth 1 -printf "%P\n"') --delete-excluded wilmot@fias.uni-frankfurt.de:~/Documents/code/coppelia_sim_inverse_model/experiments/ ~/Code/coppelia_sim_inverse_model/experiments
